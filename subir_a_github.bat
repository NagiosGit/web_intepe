...
echo [3/5] Verificando y sincronizando cambios remotos previos...
git pull --rebase https://github.com/IntepeGit/web_intepe.git main > nul 2>&1

echo.
echo [4/5] Subiendo a repositorio 1: NagiosGit (Produccion Vercel)...
git push https://github.com/NagiosGit/web_intepe.git main

echo.
echo [5/5] Subiendo a repositorio 2: IntepeGit (Respaldo Corporativo)...
