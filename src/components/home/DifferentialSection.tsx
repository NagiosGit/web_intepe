...
export const DifferentialSection: React.FC = () => {
  return (
    <section className="py-24 bg-[#1F2923] text-white relative overflow-hidden">
      
      {/* Decorative ambient subtle warm glow */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#B86B42]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 sm:p-12 border border-white/10 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 space-y-4 text-center lg:text-left">
              ...
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-[#FAF6EE] text-xs font-semibold">
              ...
              <div className="flex flex-wrap gap-4 pt-2 justify-center lg:justify-start text-xs text-stone-300">
                <div className="flex items-center space-x-1.5">
                  <CheckCircle2 className="w-4 h-4 text-[#B86B42]" />
                  <span>Sin cobros de licencias por usuario adicional</span>
                </div>
                <div className="flex items-center space-x-1.5">
                  <CheckCircle2 className="w-4 h-4 text-[#B86B42]" />
            ...
            <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3 justify-center items-center lg:items-end">
              <Link
                to="/contacto"
                className="w-full sm:w-auto lg:w-full px-7 py-4 rounded-xl font-bold text-xs uppercase tracking-wider text-center text-stone-900 bg-[#FDFBF7] hover:bg-[#FAF6EE] shadow-md hover:shadow-lg transition-all flex items-center justify-center space-x-2"
              >
