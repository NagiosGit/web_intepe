  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className="absolute -top-6 -left-3 z-30 flex items-center gap-2 px-3 py-1 rounded bg-[#0F172A]/95 border border-cyan-500/40 text-cyan-400 font-mono text-[10px] shadow-[0_0_20px_rgba(0,229,255,0.25)] transition-transform duration-300"
        ...
        <div 
          className="absolute -top-8 -right-4 z-30 p-3 rounded-lg bg-[#11192A]/95 border border-[#FF7120]/50 shadow-[0_0_25px_rgba(255,113,32,0.3)] hud-box transition-transform duration-300 hidden sm:flex flex-col items-center gap-1"
        ...
        <div className="rounded-2xl p-6 sm:p-7 border border-white/20 bg-[#1E293B]/90 backdrop-blur-2xl hud-box shadow-[0_30px_70px_rgba(0,0,0,0.5)] overflow-hidden relative">
          <div className="hud-corner-tl"></div>
          <div className="hud-corner-tr"></div>
          <div className="hud-corner-bl"></div>
          <div className="hud-corner-br"></div>
          ...
          <div className="flex items-center justify-between pb-4 mb-5 border-b border-white/10 relative z-10">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded bg-[#FF7120]/20 border border-[#FF7120]/40 flex items-center justify-center text-[#FF7120]">
            ...
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 text-[10px] font-mono font-bold bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 rounded-full flex items-center gap-1.5">
          ...
          <div className="my-5 p-4 rounded-xl bg-[#0F172A]/95 border border-white/15 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-white/10 text-[11px] font-mono text-slate-400 relative z-10">
              <div className="flex items-center gap-1.5 text-cyan-400 font-bold">
                <Server className="w-3.5 h-3.5" />
                <span>RACK MULTI-TENANT // 100% OPERACIONAL</span>
              </div>
              <span className="text-emerald-400 font-mono font-bold">99.8% SLA</span>
            </div>

            {/* Server Rack Blades */}
            <div className="space-y-2 relative z-10 font-mono">
              {/* Blade 1: Help Desk Cluster */}
              <div className="p-2.5 rounded bg-white/[0.06] border border-white/10 flex items-center justify-between hover:border-cyan-500/50 transition-colors">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></span>
                  <span className="text-white text-xs font-semibold">Mesa de Ayuda L1/L2/L3</span>
                </div>
                <div className="flex items-center gap-2 text-[11px]">
                  <span className="text-slate-300">Cola: 0 req</span>
                  <span className="px-1.5 py-0.2 rounded bg-cyan-500/25 text-cyan-200 font-bold border border-cyan-500/40">&lt; 15 min</span>
                </div>
              </div>

              {/* Blade 2: Cloud Infrastructure */}
              <div className="p-2.5 rounded bg-white/[0.06] border border-white/10 flex items-center justify-between hover:border-[#FF7120]/50 transition-colors">
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2 text-[11px]">
                  ...
                  <span className="px-1.5 py-0.2 rounded bg-amber-500/25 text-amber-200 font-bold border border-amber-500/40">Activo</span>
                </div>
              </div>

              {/* Blade 3: Security & UTM */}
              <div className="p-2.5 rounded bg-white/[0.06] border border-white/10 flex items-center justify-between hover:border-emerald-500/50 transition-colors">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
                  <span className="text-white text-xs font-semibold">Firewall & Ciberseguridad</span>
                </div>
                <div className="flex items-center gap-3 text-[11px]">
                  <span className="text-slate-300">Fortinet / VPN</span>
                  <span className="px-1.5 py-0.2 rounded bg-emerald-500/25 text-emerald-200 font-bold border border-emerald-500/40">Cifrado TLS</span>
                </div>
              </div>
            </div>

            {/* Micro Audio / Pulse wave ticker */}
            <div className="mt-3 pt-2 border-t border-white/5 flex items-center justify-between text-[10px] font-mono text-slate-300">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div className="p-3.5 rounded-xl bg-[#0F172A]/90 border border-white/15 space-y-1">
              ...
              <span className="text-[10px] text-slate-400 block">Garantía contractual</span>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-[#0F172A]/90 border border-white/15 space-y-1">
              ...
              <span className="text-[10px] text-slate-400 block">Soporte inmediato</span>
            </div>
          </div>
